    ...
    <div className='bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E] text-black rounded-t-3xl mt-8 md:mt-0'>
        <div className=' flex flex-col md:flex-row justify-between p-8 md:px-32 px-5'>
            <div className=' w-full md:w-1/4'>
                <h1 className='font-semibold  text-xl pb-4'>CafeInn</h1>
                <p className=' text-sm'>
                    We welcome you and any of your patrons into our fine establishment hope you enjoy our service and give a good recommendation to any Of Your close friends

                </p>
            </div>
            <div>
                <h1 className=' font-medium text-xl pb-4 pt-5 md:pt-6'>Links</h1>
            ...
            <div>
                <h1 className=' font-medium text-xl pb-4 pt-5 md:pt-6'>Menu</h1>
                <nav className=' flex flex-col gap-2 '>
            ...
            <div>
                <h1 className=' font-medium text-xl pb-4 pt-5 md:pt-6'>Contact us</h1>
                <nav className=' flex flex-col gap-2 '>
                    <a className='hover: text-backgroundColor transition-all cursor-pointer' href="/">
                        CafeInn@gmail.com
                    </a>
                    <a className='hover: text-amber-300 transition-all cursor-pointer' href="/">
                        +25 956 230 500
                    </a>
                    <a className='hover: text-blue-50 transition-all cursor-pointer' href="/">
                        Social media
                    </a>
                </nav>
            </div>
        ...
        <div>
            <p className=' text-center py-3'>
                ...
                <span className=' text-backgroundColor'> Group 1 programmers</span>
                All rights reserved
            </p>
        </div>
    </div>
